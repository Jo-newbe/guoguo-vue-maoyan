<template>
  <div class="bottom-nav-bar">
    <div class="nav-icon-wrapper" :class="{current: selectedTab=='.movie'}" data-tab=".movie">
      <router-link to="/movie/.n-hot">
    ...
    <div class="nav-icon-wrapper" :class="{current: selectedTab=='.cinema'}" data-tab=".cinema">
    ...
    <div class="nav-icon-wrapper" :class="{current: selectedTab=='.my'}" data-tab=".my">
      <router-link to="/my">
...
svg, .bottom-nav-bar svg>g path, .bottom-nav-bar svg>path {
  fill: #696969;
}
</style>
